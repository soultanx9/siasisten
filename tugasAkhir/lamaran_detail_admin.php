...
<table cellspacing="0" cellpadding="0">
  <?php
	...
	where m.npm = l.npm and m.npm = tm.npm order by m.npm asc limit 1;");
...
<table cellspacing="0" cellpadding="0">
	...
	where mk.kode = km.kode_mk and mkm.idkelasmk = km.idkelasmk order by mk.nama asc limit 1;");
...
<form action="proses_rekom.php" method="post">
		<input type="submit" class="button" value="Terima" style="background-color:#0099FF; "/>
</form>